...
class MobileNetV2EmotionRecognizer:
    def __init__(self, data_dir, val_dir, model_path="models/mobilenetv2_emotion.pth", batch_size=32, lr=3e-4, device=None):
    ...
    def _prepare_data(self):
        ...
        valset = datasets.ImageFolder(self.val_dir, transform=self.transform2)
        self.class_names = dataset.classes
        self.num_classes = len(self.class_names)

        self.train_loader = DataLoader(dataset, batch_size=self.batch_size, shuffle=True, num_workers=4)
        self.val_loader = DataLoader(valset, batch_size=self.batch_size, num_workers=4)
