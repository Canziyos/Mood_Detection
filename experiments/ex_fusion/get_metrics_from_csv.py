...
fusion_mode = "avg"  # "avg", "prod", "gate", etc.

df = pd.read_csv(f'../results/new_unsync_fusion_results_{fusion_mode}.csv')
...
{image_r}
"""
metrics_path = f"{out_dir}/new_metrics_report_{fusion_mode}.txt"
...
plt.tight_layout()
plt.savefig(f"{out_dir}/new_cm_fusion_{fusion_mode}.png")
plt.show()
...
plt.xlabel('Predicted')
plt.tight_layout()
plt.savefig(f"{out_dir}/new_cm_fusion_normalized_{fusion_mode}.png")
plt.show()
